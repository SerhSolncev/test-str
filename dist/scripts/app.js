...
var main = __webpack_require__(988);
// EXTERNAL MODULE: ./src/content/scss/main.scss
var scss_main = __webpack_require__(500);
...
var glightbox = __webpack_require__(117);
;// ./src/index.js
...
document.addEventListener('DOMContentLoaded', event => {
  ...
  // lazy-load
  let lazyLoadInstance = new (lazyload_min_default())({
  ...
  if (showElementYX.length > 0) {
    ...
    showElementYX.forEach(element => {
      ...
      gsapWithCSS.fromTo(element, from, {
        ...to,
        scrollTrigger: {
          trigger: element,
          start: start,
  ...
  animatedBlocks.forEach(block => {
    ...
    gsapWithCSS.set(block.querySelectorAll(".js-animate-symbol"), {
  ...
  function initGLightbox() {
    ...
    lightbox = glightbox_min_default()({
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("cfd26d3aeff677aeb113")
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "webpack-template-pug:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdatewebpack_template_pug"] = (chunkId, moreModules, runtime) => {
